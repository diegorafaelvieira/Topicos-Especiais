...
begin
  ...
  dm.tbProdutos.Open;
  dm.tbFornec.Open(); //Também abre a tab Fornecedores
end;
...
begin
  ...
  begin
    MessageDlg('Falta digitar a descrição do produto', mtWarning, [mbOk], 0);
    DBEdit2.SetFocus;
    Exit;
  end;

  dm.tbProdutos.Post; // Grava as informações
  TrataBotoes;
end;
