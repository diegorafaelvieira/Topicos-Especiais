...
begin
  ...
  begin
    MessageDlg('Falta digitar a descrição do vendedor', mtWarning, [mbOk], 0);
    DBEdit2.SetFocus;
    Exit;
  end;

  dm.tbVendedores.Post; // Grava as informações
  TrataBotoes;
end;
...
begin
  ...
  dm.tbVendedores.Last; // Posiciona no último registro
...
begin
  ...
  begin
    MessageDlg('Cancele ou confirme a operação', mtWarning, [mbOk], 0);
    Exit;
  end;
  Close;
end;
