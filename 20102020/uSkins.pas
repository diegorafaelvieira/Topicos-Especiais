...
var ind, ii, totCarac, totNum, totEsp : integer;
    txt : string;
begin
     totCarac := 0;
     totNum := 0;
     ...
     MessageDlg('Total de Letras:' + totCarac.ToString + #13 +
                'Total de Números:' + totNum.ToString + #13 +
                'Total de Especiais:' + totEsp.ToString ,
