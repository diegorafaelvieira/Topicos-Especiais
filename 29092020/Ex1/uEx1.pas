...
begin
     ...
     if op2 = 0 then
     begin
          messagedlg('Divisão por ZERO!!!!',
                  mtError,
                  [mbOk],
                  0);
          lbRes.caption := ' = Não existe divisão por ZERO!';
          Exit;
     end;
...
begin
     ...
     begin
       messagedlg('Não foi digitado um número',
                  mtError,
                  [mbOk],
                  0);
       Result := False;
     ...
     begin
       messagedlg('Não foi digitado um valor numérico no Op1',
                  mtError,
                  [mbOk],
                  0);
       aOP1.SetFocus;
     ...
     begin
          messagedlg('Não foi digitado um valor numérico para Op2',
                     mtError,
                     [mbOk],
                     0);
          aOP2.SetFocus;
