...
begin
  ...
  begin
    rgMamiferos.Visible := True;   //Exibo Mamíferos
    rgRepteis.ItemIndex := -1;
    rgAves.ItemIndex := -1;
    rgNaoVoadores.ItemIndex := -1;
  ...
  begin
    rgRepteis.Visible := True;  //Exibo Répteis
    rgMamiferos.ItemIndex := -1;
    rgAves.ItemIndex := -1;
    rgNaoVoadores.ItemIndex := -1;
    rgQuadrupede.ItemIndex := -1;
