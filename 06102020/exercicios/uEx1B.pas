...
begin
  { Professor explicou que não existe conversão para FOR
   porque o FOR é determinado }
   ShowMessage('Não existe conversão para FOR porque o FOR é determinado');
end;
...
begin
  ...
  begin
    ...
    gh := InputBox('Deseja continuar (S/N)', 'Opção','S');
  end;
